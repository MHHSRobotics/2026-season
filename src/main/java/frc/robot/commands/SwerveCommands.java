...
public class SwerveCommands {
    ...
    public Command lock() {
        return new InstantCommand(() -> swerve.lock(), swerve, swerveTranslation, swerveRotation)
                .withName("swerve lock");
    }

    // Stops all swerve output
    public Command stop() {
        return new InstantCommand(() -> swerve.stop(), swerve, swerveTranslation, swerveRotation)
